# 🧩 MySQL Mini Project — Employee Promotion and Analysis System
...
### 3️⃣ Table: `employees_informations`
...
## ⚙️ Trigger — `promotion_insert`
This trigger runs **after every insertion** in the `employees_informations` table.  
If the inserted employee’s salary is greater than 70,000, it automatically adds that record into the `promotion_log` table.
...
```
➡️ The above employee will automatically appear in the `promotion_log` table.

---

## 🧮 Stored Procedure — `analyze_employee()`
...
## 🧑‍💻 Author
**👋 Zoubir Chatti**  
🎓 Data & Signal Processing Student | Learning MySQL & Data Analysis  
📍 Marseille, France 🇫🇷  
💡 Passionate about data and continuous learning.
